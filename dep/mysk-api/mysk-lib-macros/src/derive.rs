...
pub(crate) fn get_by_id(input: TokenStream) -> TokenStream {
    ...
    let base_query = quote! { <Self as mysk_lib::models::traits::BaseQuery>::base_query() };
    ...
    let expanded = quote! {
        use mysk_lib::models::traits::BaseQuery as _;

        #[automatically_derived]
        #[::async_trait::async_trait]
        impl mysk_lib::models::traits::GetById for #ident {
...
pub(crate) fn base_query(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        #[automatically_derived]
        impl mysk_lib::models::traits::BaseQuery for #ident {
            #[must_use]
